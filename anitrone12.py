...
class MyWindow(QWidget):
    def __init__(self):
        ...
        self.setGeometry(0, 200, 1440, 440)
...
button8 = Element(1, 2)
button9 = Element(1, 3)
button10 = Element(1, 4)
button11 = Element(1, 5)
...
grid.addWidget(button9, 1, 3)
grid.addWidget(button10, 1, 4)
grid.addWidget(button11, 1, 5)
